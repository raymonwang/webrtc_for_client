...
OBJS := \
	$(obj).target/$(TARGET)/chromium/src/third_party/opus/src/src/opus_compare.o
...
$(builddir)/opus_compare: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/opus_compare: LIBS := $(LIBS)
$(builddir)/opus_compare: LD_INPUTS := $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a
$(builddir)/opus_compare: TOOLSET := $(TOOLSET)
$(builddir)/opus_compare: $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/opus_compare
# Add target alias
.PHONY: opus_compare
opus_compare: $(builddir)/opus_compare
