...
OBJS := \
	$(obj).target/$(TARGET)/chromium/src/third_party/opus/src/tests/test_opus_decode.o
...
$(builddir)/test_opus_decode: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/test_opus_decode: LIBS := $(LIBS)
$(builddir)/test_opus_decode: LD_INPUTS := $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a
$(builddir)/test_opus_decode: TOOLSET := $(TOOLSET)
$(builddir)/test_opus_decode: $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/test_opus_decode
# Add target alias
.PHONY: test_opus_decode
test_opus_decode: $(builddir)/test_opus_decode
