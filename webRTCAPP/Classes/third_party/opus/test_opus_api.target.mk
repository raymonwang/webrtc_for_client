...
OBJS := \
	$(obj).target/$(TARGET)/chromium/src/third_party/opus/src/tests/test_opus_api.o
...
$(builddir)/test_opus_api: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/test_opus_api: LIBS := $(LIBS)
$(builddir)/test_opus_api: LD_INPUTS := $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a
$(builddir)/test_opus_api: TOOLSET := $(TOOLSET)
$(builddir)/test_opus_api: $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/test_opus_api
# Add target alias
.PHONY: test_opus_api
test_opus_api: $(builddir)/test_opus_api
