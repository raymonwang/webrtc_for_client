...
OBJS := \
	$(obj).target/$(TARGET)/chromium/src/third_party/opus/src/tests/test_opus_encode.o
...
$(builddir)/test_opus_encode: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/test_opus_encode: LIBS := $(LIBS)
$(builddir)/test_opus_encode: LD_INPUTS := $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a
$(builddir)/test_opus_encode: TOOLSET := $(TOOLSET)
$(builddir)/test_opus_encode: $(OBJS) $(obj).target/chromium/src/third_party/opus/libopus.a FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/test_opus_encode
# Add target alias
.PHONY: test_opus_encode
test_opus_encode: $(builddir)/test_opus_encode
